...
function UxUi() {
    ...
    this.getAddVocForm = function () {
        var s = "";
        s += "<input type='text' id='adVocLanguage' name='adVocLanguage'  />";
        s += "<input type='text' id='adVocWord' name='adVocWord'  />";
        s += this.getButton("Save Word", "con.saveAddVoc()");        
        s += "<hr>";        
        s += "<textarea id='adVocText' rows='4' cols='50'>xxx</textarea>";
        s += this.getButton("Save Text", "con.saveAddVoc()");        
        s += "<hr>";        
        s += "<textarea id='adVocUrl' rows='4' cols='50'>xxx</textarea>";
