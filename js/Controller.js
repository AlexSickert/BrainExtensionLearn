...
function Controller() {
    ...
    this.callBack = function (responseObject) {
        ...
        if (responseObject["action"] === "adVocFromUrl") {
            ...
            var c1 = responseObject["c1"];
            var c2 = responseObject["c2"];
            var c3 = responseObject["c3"];
            var c4 = responseObject["c4"];
            objUxUi.setResults(learnedWords, newWords, ratioLearned, c1, c2, c3, c4);
